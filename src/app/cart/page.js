      ...
      <div className="w-[20%] mx-auto p-6 text-lg font-bold">
        ...
        <div className="flex justify-center p-6">
          <button
            ...
            className="px-3 rounded-md py-1 border-2 bg-red-600 font-medium border-red-600 text-white whitespace-nowrap hover:border-red-500 hover:bg-red-500 duration-300"
          >
            Proceed to Checkout
          </button>
        </div>
